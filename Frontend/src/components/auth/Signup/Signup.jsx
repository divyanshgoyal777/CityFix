...
import UserSignup from "./SignupType/UserSignup";
import GovernmentSignup from "./SignupType/GovernmentSignup";
        ...
        <div className="max-w-xl mx-auto px-4 py-12">
          ...
          <div className="bg-white border border-gray-200 rounded-xl shadow-lg p-6 md:p-8">
            ...
            <p className="text-center text-gray-500 mb-6">
              Select your signup type to begin
            </p>
            ...
            {selected === "user" && <UserSignup />}
            {selected === "government" && <GovernmentSignup />}
          </div>
        </div>
      </main>
      <Footer />
