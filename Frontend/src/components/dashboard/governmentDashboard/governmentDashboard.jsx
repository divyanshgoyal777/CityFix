...
const GovernmentDashboard = () => {
  ...
  const navLinks = [
    { label: "Home", icon: <Home size={18} />, path: "/government/dashboard" },
    {
      label: "View Issues",
      icon: <FileSearch size={18} />,
      path: "/government/dashboard/viewPosts",
    },
    {
      label: "View Progress",
    ...
    },
    {
      label: "Profile",
      icon: <User size={18} />,
      path: "/government/dashboard/governmentProfile",
    },
    {
      label: "Settings",
      icon: <Settings size={18} />,
      path: "/government/dashboard/settings",
    },
  ];
  ...
  return (
    <>
      ...
      <div className="md:hidden bg-white border-b border-gray-200 px-4 py-3 flex justify-between items-center shadow-sm">
        <h1 className="text-lg font-semibold text-gray-800">Gov. Dashboard</h1>
        <button
