...
const GovernmentDashboardWelcome = () => {
  return (
    <motion.div
    ...
    >
      ...
      >
        Monitor public reports, update issue statuses, and track resolution
        progress — all in one place to boost civic response and accountability.
      </motion.p>
    </motion.div>
  );
};

export default GovernmentDashboardWelcome;
