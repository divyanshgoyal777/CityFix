...
import { FileText, Users, Building2, Menu, X, Home } from "lucide-react";
...
const AdminDashboard = () => {
  ...
  const navLinks = [
    ...
    },
    {
      ...
      path: "/admin/dashboard/managePosts",
    },
    {
      label: "Manage Users",
      icon: <Users size={18} />,
    ...
    {
      label: "Manage Government",
      icon: <Building2 size={18} />,
      path: "/admin/dashboard/manageGovernment",
    },
  ];
